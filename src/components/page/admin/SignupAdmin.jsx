...
import { registerAdmin, registerEducator } from "../../../api/auth";
...
export default function SignUpAdmin() {
    ...
    const handleSignUp = async (e) => {
        ...
        if (isValidate) {
            ...
            const responseRegisterAdmin = await registerAdmin(userName, password);
            handleApiResponse(responseRegisterAdmin,
                () => {
                    setAlert(stringAlert.signupSuccess);
                    setIsSuccess(true);
                },
    ...
    return (
        <Paper
            ...
            <Stack direction="column" spacing={2}>
                ...
                <Typography variant="body2" >
                    Đã có tài khoản?
                    <Link href="/login/admin"> Đăng nhập</Link>
                </Typography>
            </Stack>
        </Paper>
    )
