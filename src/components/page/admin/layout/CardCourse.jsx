          ...
          <Box>
            <CardContent sx={{}}>
              <Typography component="div" variant="h6">
                {courseState.name && courseState.name.length > 20
                  ? `${courseState.name.substring(0, 20)}...`
                  : courseState.name || "undefined"}
              </Typography>
              <Typography
                variant="subtitle1"
              ...
              >
                tác giả:{" "}
                {`${courseState?.user?.lastName} ${courseState?.user?.firstName}`}
              </Typography>
            </CardContent>
          </Box>
        </Box>
