...
const listItemNavAccount = [itemNav("Hồ sơ", <AccountBox />, "profile")];

const listItemNavCourse = [
  itemNav("Thống kê", <BarChart />, "char"),
  itemNav("Khóa học", <LocalLibrary />, "course"),
  itemNav("Các câu hỏi", <QuestionAnswerIcon />, "question"),
];
      ...
      <Drawer variant="permanent" open={openState}>
        ...
        <List>
          <ListItem disablePadding sx={{ display: "block", color: "inherit" }}>
            <ItemComponent open={openState} listItem={listItemNavCourse} />
          </ListItem>
        </List>
        <Divider />
        <List>
          <ListItem disablePadding sx={{ display: "block" }}>
            <ItemComponent open={openState} listItem={listItemNavAccount} />
